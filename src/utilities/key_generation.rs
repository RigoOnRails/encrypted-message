...
/// Derives a new 32-byte key from a raw key using the salt & iterations provided.
///
/// You should use this function to derive keys from human-provided keys/passwords,
